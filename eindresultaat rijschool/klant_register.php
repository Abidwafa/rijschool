...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $db = new Database();
    $result = $db->select("SELECT * FROM klanten WHERE gebruikersnaam = :gebruikersnaam", [':gebruikersnaam' => $gebruikersnaam]);
    if (!empty($result)) {
        ...
        if ($wachtwoord !== $confirm_wachtwoord) {
            ...
            $db->insert("INSERT INTO klanten (naam, gebruikersnaam, wachtwoord) VALUES (:naam, :gebruikersnaam, :wachtwoord)", [':naam' => $naam, ':gebruikersnaam' => $gebruikersnaam, ':wachtwoord' => $hashed_wachtwoord]);
        ...
        <div class="col col-sm-6 col-md-6 col-lg-4 col-xl-3">
            <div class="form-group">
                <form method="POST"><br><br>
                    ...
                    <?php } ?>
                    <input type="text" name="naam" placeholder="naam" class="form-control form-control-lg" required><br>
